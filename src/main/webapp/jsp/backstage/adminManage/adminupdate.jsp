...
<div class="formbody">
    ...
    <form id="myForm">
        <ul class="forminfo">
            ...
            <li><label>帐户名：</label><input name="a_username" type="text" class="dfinput" value="${requestScope.admin.a_username }" /></li><br/>
            <li><label>昵称：</label><input name="a_name" type="text" class="dfinput" value="${requestScope.admin.a_name }"/></li>
